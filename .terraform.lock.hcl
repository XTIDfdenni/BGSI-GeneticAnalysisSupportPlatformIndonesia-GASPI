...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "6.0.0"
  constraints = ">= 4.22.0, >= 5.14.0, >= 5.69.0, >= 5.79.0, >= 5.93.0"
  hashes = [
