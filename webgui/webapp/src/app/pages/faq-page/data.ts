...
export const faqItemsData: FaqItem[] = [
  {
    ...
    html: `
        ...
        <div>
          <strong>Clinical Workflow Results</strong> are generated by processing
          the uploaded VCF file to query relevant genomic databases. Each
          hospital implements the workflow according to its research focus:
        </div>
        <ul>
          <li>
            <strong>RSUP Nasional Dr. Cipto Mangunkusumo (RSCM)</strong> -
            Focus: Metabolic diseases, particularly the assessment of Familial
            Hypercholesterolemia (FH). Results are obtained from Variant Effect
            Predictor (VEP), ClinVar, gnomAD, gnomAD 1KG, and gnomAD Constraint.
          </li>
          <li>
            <strong>RSUP Dr. Sardjito (SARDJITO)</strong> - Focus: Rare
            diseases, especially rare muscular dystrophy and cardiac diseases.
            Results are obtained from VEP, ClinVar, gnomAD, gnomAD 1KG, and
            gnomAD Constraint.
          </li>
          <li>
            <strong
          ...
          <li>
            <strong>RSUP I Goesti Ngoerah Goesti Ngoerah (IGNG)</strong>
            - Focus: Aging, nutrition, and wellness, with emphasis on immune
            diseases. Results are obtained from the Association Matrix.
          </li>
          <li>
            <strong
              ...
              (RSJPD)</strong
            >
            - Focus: Cardiovascular diseases. Results are obtained from
            Pharmacogenomics and the Association Matrix.
          </li>
        </ul>
      </div>
    `,
